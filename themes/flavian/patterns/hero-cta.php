...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1,"fontSize":"3x-large","fontFamily":"heading"} -->
<h1 class="wp-block-heading has-text-align-center has-heading-font-family has-3-x-large-font-size">Welcome to Flavian</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
<p class="has-text-align-center has-medium-font-size">Discover a beautifully crafted theme designed for modern websites. Build something extraordinary with the power of Full Site Editing.</p>
<!-- /wp:paragraph -->
