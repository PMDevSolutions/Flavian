<?php
/**
 * Title: Single Testimonial Quote
 * Slug: flavian/testimonial-single
 * Categories: flavian-testimonials, text
...
<blockquote class="wp-block-quote is-style-plain"><!-- wp:paragraph {"fontSize":"large","style":{"typography":{"fontStyle":"italic"}}} -->
<p class="has-large-font-size" style="font-style:italic">This product completely transformed how we work. The attention to detail and customer support are unmatched.</p>
<!-- /wp:paragraph --><cite>Jane Doe, CEO of Example Corp</cite></blockquote>
<!-- /wp:quote --></div>
<!-- /wp:group -->
